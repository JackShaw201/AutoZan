...
def run(qq: str, interval: int, loginmode: int | None, b2: maliang.Button, text1: maliang.Text):
    b2.forget(False)
    try:
        global driver
...
def start(qq: str, interval: int, loginmode: int | None, b2: maliang.Button, text1: maliang.Text):
    threading.Thread(target=run, args=(qq, interval, loginmode, b2, text1)).start()
